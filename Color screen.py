...
# White begin block
s.configure('Danger.TFrame', background='white',
            borderwidth=50, relief='raised')
...
# Buttons
button = ttk.Button(root, text='red', command=red).grid(
    column=3, row=3, sticky=W)
button = ttk.Button(root, text='green', command=green).grid(
    column=4, row=3, sticky=W)
button = ttk.Button(root, text='orange', command=orange).grid(
...
ttk.Button(root, text="Calculate", command=calculate).grid(
